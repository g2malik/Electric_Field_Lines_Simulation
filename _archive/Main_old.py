...
def add_charge():
    ...
    y=0
    q=0
    charge_points.append(PointCharge(x, y, q))
...
h3_frame = tk.LabelFrame(b_frame)
h3_frame.grid(column = 0, row = 2, sticky = "n")
h3_frame['borderwidth'] = frame_width
h3_frame['bg'] = bag
